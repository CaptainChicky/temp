  ...
  return (function a(b, c, d) {
  ...
  })(
    {
          ...
          a("./error_helpers"),
            (d.prototype.arc = function (a, b, c, f, g, h, i) {
              if (
                ...
                return this;
              for (
                this._angleMode === e.DEGREES &&
                ((g = this.radians(g)), (h = this.radians(h)));
                g < 0;
        ...
        function (a, b, c) {
          ...
          (e.Renderer = function (a, b, c) {
            ...
            (e.Renderer.prototype.textStyle = function (a) {
              return a
                ? ((a !== f.NORMAL && a !== f.ITALIC && a !== f.BOLD) ||
        ...
        function (a, b, c) {
          ...
          (d.Renderer2D = function (a, b, c) {
            ...
            (d.Renderer2D.prototype.loadPixels = function () {
              ...
              this._pInst
                ? (this._pInst._setProperty("imageData", d),
                  this._pInst._setProperty("pixels", d.data))
                : (this._setProperty("imageData", d),
                  this._setProperty("pixels", d.data));
            }),
            (d.Renderer2D.prototype.set = function (a, b, c) {
              if (
                ((a = Math.floor(a)), (b = Math.floor(b)), c instanceof d.Image)
              )
                this.drawingContext.save(),
                  this.drawingContext.setTransform(1, 0, 0, 1, 0, 0),
                  this.drawingContext.scale(
            ...
            (d.Renderer2D.prototype.shearX = function (a) {
              return (
                this._pInst._angleMode === f.DEGREES &&
                  (a = this._pInst.degrees(a)),
      ...
      30: [
        function (a, b, c) {
          ...
          (d.prototype.createCanvas = function (a, b, c) {
            ...
            return (
              this._setupDone ||
                ((g.dataset.hidden = !0), (g.style.visibility = "hidden")),
              this._userNode
                ? this._userNode.appendChild(g)
                : document.body.appendChild(g),
              h === e.WEBGL
                ? (this._setProperty(
                    "_renderer",
                    new d.RendererGL(g, this, !0)
                  ),
                  this._elements.push(this._renderer))
                : this._defaultGraphicsCreated ||
                  (this._setProperty(
                    "_renderer",
                    new d.Renderer2D(g, this, !0)
                  ),
          ...
          (d.prototype.applyMatrix = function (a, b, c, d, e, f) {
            ...
            (d.prototype.rotate = function (a, b) {
              ...
              return (
                this._angleMode === e.DEGREES
                  ? (c = this.radians(a))
                  : this._angleMode === e.RADIANS && (c = a),
                this._renderer.rotate(c, b),
                this
              );
            }),
            ...
            (d.prototype.shearX = function (a) {
              return (
                ...
                this._angleMode === e.DEGREES && (a = this.radians(a)),
          ...
          a("../core/error_helpers"),
            ...
            (h.prototype.httpDo = function () {
              for (
                ...
                h > 0 && "function" == typeof arguments[h];
                h--
              )
                f++;
              if (
                ...
                for (
                  var j, k = arguments[0], l = "GET", m = 1;
                  m < arguments.length;
                  m++
                ) {
                  var n = arguments[m];
                  if ("string" == typeof n)
                    "GET" === n || "POST" === n || "PUT" === n || "DELETE" === n
                      ? (l = n)
                      : "json" === n ||
                        "jsonp" === n ||
                        "xml" === n ||
            ...
            (h.prototype.createWriter = function (a, b) {
              ...
              for (var d in h.prototype._pWriters)
                if (h.prototype._pWriters[d].name === a)
                  return (
                    (c = new h.PrintWriter(a + window.millis(), b)),
                    h.prototype._pWriters.push(c),
                    c
                  );
              return (
                (c = new h.PrintWriter(a, b)), h.prototype._pWriters.push(c), c
              );
            }),
              ...
              (this.name = a),
                ...
                (this.close = function () {
                  ...
                  for (var e in h.prototype._pWriters)
                    h.prototype._pWriters[e].name === this.name &&
                      h.prototype._pWriters.splice(e, 1);
                  c.flush(), (c = {});
                });
            }),
                ...
                switch (f(d[1], d[2])[1]) {
                  ...
                  default:
                    d[0] instanceof Array
                      ...
                      ? h.prototype.saveTable(d[0], d[1], d[2])
                      : d[0] instanceof h.Image
                      ? h.prototype.saveCanvas(d[0].canvas, d[1])
                      : d[0] instanceof h.SoundFile &&
                        h.prototype.saveSound(d[0], d[1], d[2], d[3]);
                }
              }
            }),
              ...
              if (("tsv" === d && (h = "\t"), "html" !== d)) {
                ...
                for (var j = 0; j < a.rows.length; j++) {
                  ...
                  for (k = 0; k < a.rows[j].arr.length; k++)
                    k < a.rows[j].arr.length - 1
                      ? f.write(a.rows[j].arr[k] + h)
                      : (a.rows.length, f.write(a.rows[j].arr[k]));
                  f.write("\n");
                }
              } else {
      ...
      52: [
        function (a, b, c) {
          ...
          (d.Vector = function () {
            ...
            (d.Vector.prototype.rotate = function (a) {
              ...
              this.p5 &&
                this.p5._angleMode === f.DEGREES &&
                (b = e.degreesToRadians(b));
              var c = this.mag();
              return (
            ...
            (d.Vector.fromAngle = function (a, b) {
              return (
                ...
                void 0 === b && (b = 1),
                this.p5
                  ? new d.Vector(this.p5, [b * Math.cos(a), b * Math.sin(a), 0])
            ...
            (d.Vector.fromAngles = function (a, b, c) {
              this.p5 &&
                this.p5._angleMode === f.DEGREES &&
                ((a = e.degreesToRadians(a)), (b = e.degreesToRadians(b))),
                void 0 === c && (c = 1);
              var g = Math.cos(b),
                h = Math.sin(b),
                i = Math.cos(a),
                j = Math.sin(a);
              return this.p5
                ? new new d.Vector(this.p5, c * j * h, -c * i, c * j * g)()
                : new d.Vector(c * j * h, -c * i, c * j * g);
            }),
            (d.Vector.random2D = function () {
              ...
              return (
                (a = this.p5
                  ? this.p5._angleMode === f.DEGREES
                    ? this.p5.random(360)
                    : this.p5.random(f.TWO_PI)
                  : Math.random() * f.TWO_PI),
                this.fromAngle(a)
              );
            }),
            (d.Vector.random3D = function () {
              var a, b;
              this.p5
                ? ((a = this.p5.random(0, f.TWO_PI)),
                  (b = this.p5.random(-1, 1)))
                : ((a = Math.random() * f.TWO_PI), (b = 2 * Math.random() - 1));
              var c = Math.sqrt(1 - b * b),
                e = c * Math.cos(a),
                g = c * Math.sin(a);
              return this.p5
                ? new d.Vector(this.p5, [e, g, b])
                : new d.Vector(e, g, b);
            }),
        ...
        { "../core/constants": 20, "../core/core": 21, "./polargeometry": 53 }
      ],
      53: [
        function (a, b, c) {
          "use strict";
        ...
        function (a, b, c) {
          ...
          (d.prototype._angleMode = f.RADIANS),
            (d.prototype.acos = function (a) {
              return this._angleMode === f.RADIANS
                ? Math.acos(a)
                : e.radiansToDegrees(Math.acos(a));
            }),
            (d.prototype.asin = function (a) {
              return this._angleMode === f.RADIANS
                ? Math.asin(a)
                : e.radiansToDegrees(Math.asin(a));
            }),
            (d.prototype.atan = function (a) {
              return this._angleMode === f.RADIANS
                ? Math.atan(a)
                : e.radiansToDegrees(Math.atan(a));
            }),
            (d.prototype.atan2 = function (a, b) {
              return this._angleMode === f.RADIANS
                ? Math.atan2(a, b)
                : e.radiansToDegrees(Math.atan2(a, b));
            }),
            (d.prototype.cos = function (a) {
              return this._angleMode === f.RADIANS
                ? Math.cos(a)
                : Math.cos(this.radians(a));
            }),
            (d.prototype.sin = function (a) {
              return this._angleMode === f.RADIANS
                ? Math.sin(a)
                : Math.sin(this.radians(a));
            }),
            (d.prototype.tan = function (a) {
              return this._angleMode === f.RADIANS
                ? Math.tan(a)
                : Math.tan(this.radians(a));
            }),
          ...
          (d.prototype.camera = function () {
            ...
            (d.RendererGL.prototype.perspective = function (a, b, c, e) {
              void 0 === a && (a = this.defaultCameraFOV),
                ...
                (this.cameraNear = c),
                (this.cameraFar = e),
                (this.uPMatrix = d.Matrix.identity(this.pInst));
            ...
            (d.prototype.ortho = function () {
              return (
                this._renderer.ortho.apply(this._renderer, arguments), this
              );
            }),
            (d.RendererGL.prototype.ortho = function (a, b, c, e, f, g) {
              void 0 === a && (a = -this.width / 2),
                ...
                (this.uPMatrix = d.Matrix.identity(this._pInst));
              var h = b - a,
                i = e - c,
                j = g - f,
                k = 2 / h,
      ...
      65: [
        function (a, b, c) {
          ...
          (d.prototype.ambientLight = function (a, b, c, d) {
            ...
            return (
              f.setUniform("uUseLighting", !0),
              f.setUniform("uMaterialColor", this._renderer.curFillColor),
              this._renderer.ambientLightColors.push(
                e._array[0],
                e._array[1],
                e._array[2]
              ),
              f.setUniform("uAmbientColor", this._renderer.ambientLightColors),
              f.setUniform(
                "uAmbientLightCount",
            ...
            (d.prototype.directionalLight = function (a, b, c, d, e, f) {
              var g,
                h,
                i,
                j = this._renderer._useLightShader(),
                k = this.color.apply(this, [a, b, c]),
                l = arguments[arguments.length - 1];
              "number" == typeof l
                ? ((g = arguments[arguments.length - 3]),
                  (h = arguments[arguments.length - 2]),
                  (i = arguments[arguments.length - 1]))
                : ((g = l.x), (h = l.y), (i = l.z)),
                j.setUniform("uUseLighting", !0),
                j.setUniform("uMaterialColor", this._renderer.curFillColor);
            ...
            (d.prototype.pointLight = function (a, b, c, d, e, f) {
              var g,
                h,
                i,
                j = this._renderer._pInst.color.apply(this, [a, b, c]),
              ...
              return (
                l.setUniform("uUseLighting", !0),
                l.setUniform("uMaterialColor", this._renderer.curFillColor),
                this._renderer.pointLightPositions.push(g, h, i),
                l.setUniform(
                  "uPointLightLocation",
            ...
            (e.prototype.model = function (a) {
              a.vertices.length > 0 &&
                (this._renderer.geometryInHash(a.gid) ||
                  (a._makeTriangleEdges(),
                  this._renderer._edgesToVertices(a),
                  this._renderer.createBuffers(a.gid, a)),
                this._renderer.drawBuffers(a.gid));
            }),
            (b.exports = e);
        },
        { "../core/core": 21, "./p5.Geometry": 68 }
      ],
      67: [
        function (a, b, c) {
          "use strict";
            ...
            (d.prototype.loadShader = function (a, b) {
              ...
              return (
                this.loadStrings(b, function (a) {
                  (c._fragSrc = a.join("\n")),
                    (f = !0),
                    g || e._incrementPreload();
                }),
                this.loadStrings(a, function (a) {
                  (c._vertSrc = a.join("\n")),
                    (g = !0),
                    f || e._incrementPreload();
                }),
                c
              );
            }),
        ...
        { "../core/constants": 20, "../core/core": 21, "./p5.Texture": 74 }
      ],
      68: [
        function (a, b, c) {
          "use strict";
          ...
          (d.Geometry = function (a, b, c) {
            ...
            (d.RendererGL.prototype._edgesToVertices = function (a) {
              ...
              for (var b = 0; b < a.edges.length; b++) {
                ...
                j.push(1),
                  k.push(-1),
                  a.lineNormals.push(j, k, j, j, k, k),
                  a.lineVertices.push(f, g, h, h, g, i);
              }
            }),
          ...
          "undefined" != typeof Float32Array &&
            ...
            (d.Matrix.prototype.mult = function (a) {
              ...
              var c = this.mat4[0],
                ...
                g = this.mat4[3];
              return (
                (this.mat4[0] = c * b[0] + e * b[4] + f * b[8] + g * b[12]),
                (this.mat4[1] = c * b[1] + e * b[5] + f * b[9] + g * b[13]),
                (this.mat4[2] = c * b[2] + e * b[6] + f * b[10] + g * b[14]),
                (this.mat4[3] = c * b[3] + e * b[7] + f * b[11] + g * b[15]),
                (c = this.mat4[4]),
                (e = this.mat4[5]),
                (f = this.mat4[6]),
                (g = this.mat4[7]),
                (this.mat4[4] = c * b[0] + e * b[4] + f * b[8] + g * b[12]),
                (this.mat4[5] = c * b[1] + e * b[5] + f * b[9] + g * b[13]),
                (this.mat4[6] = c * b[2] + e * b[6] + f * b[10] + g * b[14]),
                (this.mat4[7] = c * b[3] + e * b[7] + f * b[11] + g * b[15]),
                (c = this.mat4[8]),
                (e = this.mat4[9]),
                (f = this.mat4[10]),
                (g = this.mat4[11]),
                (this.mat4[8] = c * b[0] + e * b[4] + f * b[8] + g * b[12]),
                (this.mat4[9] = c * b[1] + e * b[5] + f * b[9] + g * b[13]),
                (this.mat4[10] = c * b[2] + e * b[6] + f * b[10] + g * b[14]),
                (this.mat4[11] = c * b[3] + e * b[7] + f * b[11] + g * b[15]),
                (c = this.mat4[12]),
                (e = this.mat4[13]),
                (f = this.mat4[14]),
                (g = this.mat4[15]),
                (this.mat4[12] = c * b[0] + e * b[4] + f * b[8] + g * b[12]),
                (this.mat4[13] = c * b[1] + e * b[5] + f * b[9] + g * b[13]),
                (this.mat4[14] = c * b[2] + e * b[6] + f * b[10] + g * b[14]),
                (this.mat4[15] = c * b[3] + e * b[7] + f * b[11] + g * b[15]),
                this
              );
            }),
            ...
            (d.Matrix.prototype.rotate = function (a, b, c, g) {
              var h, i;
              (h =
                this.p5 && this.p5._angleMode === f.DEGREES
                  ? e.degreesToRadians(a)
                  : a),
                b instanceof d.Vector
                  ? ((c = b.y), (g = b.z), (b = b.x))
                  : b instanceof Array && ((c = b[1]), (g = b[2]), (b = b[0])),
                (i = Math.sqrt(b * b + c * c + g * g)),
                (b *= 1 / i),
                (c *= 1 / i),
                (g *= 1 / i);
              var j = this.mat4[0],
                ...
                G = g * g * x + w;
              return (
                (this.mat4[0] = j * y + n * z + r * A),
                (this.mat4[1] = k * y + o * z + s * A),
                (this.mat4[2] = l * y + p * z + t * A),
                (this.mat4[3] = m * y + q * z + u * A),
                (this.mat4[4] = j * B + n * C + r * D),
                (this.mat4[5] = k * B + o * C + s * D),
                (this.mat4[6] = l * B + p * C + t * D),
                (this.mat4[7] = m * B + q * C + u * D),
                (this.mat4[8] = j * E + n * F + r * G),
                (this.mat4[9] = k * E + o * F + s * G),
                (this.mat4[10] = l * E + p * F + t * G),
                (this.mat4[11] = m * E + q * F + u * G),
                this
              );
            }),
          ...
          (d.RendererGL.prototype.beginShape = function (a) {
            ...
            (d.RendererGL.prototype.endShape = function (a, b, c, d, f, g) {
              if (
                ...
                for (var h = 0; h < this.immediateMode.vertices.length - 1; h++)
              ...
              return (
                this._doFill && this._drawFillImmediateMode(a, b, c, d, f, g),
                (this.immediateMode.vertices.length = 0),
                (this.immediateMode.vertexColors.length = 0),
                (this.immediateMode.uvCoords.length = 0),
        ...
        function (a, b, c) {
          ...
          (d.RendererGL = function (a, b, c, e) {
            return (
              ...
              (this.cameraMatrix = new d.Matrix(b)),
              this.camera(),
              (this.gHash = {}),
            ...
            (d.RendererGL.prototype.pop = function () {
              ...
              if (((this.uMVMatrix = f.pop()), 0 === g.length))
        ...
        function (a, b, c) {
          ...
          a("./p5.Geometry"),
                ...
                h.computeFaces().computeNormals(),
                  c <= 1 && e <= 1
                    ? (h._makeTriangleEdges(),
                      this._renderer._edgesToVertices(h))
                    : console.log(
            ...
            (d.prototype.box = function (a, b, c, e, f) {
              ...
              if (!this._renderer.geometryInHash(g)) {
                ...
                i.computeNormals(),
                  e <= 4 && f <= 4
                    ? (i._makeTriangleEdges(),
                      this._renderer._edgesToVertices(i))
                    : console.log(
          ...
          var e = function (a, b, c, e, f, g, h) {
            ...
            for (i = n; i <= o; ++i) {
              ...
              for (
                ...
                this.vertices.push(
                  new d.Vector(
                    Math.sin((j * Math.PI * 2) / e) * p,
                    r,
                    Math.cos((j * Math.PI * 2) / e) * p
                  )
                ),
                  this.vertexNormals.push(
                    new d.Vector(
                      i < 0 || i > f
                        ? 0
                        : Math.sin((j * Math.PI * 2) / e) * Math.cos(m),
                      i < 0 ? -1 : i > f ? 1 : Math.sin(m),
                      i < 0 || i > f
                        ? 0
                        : Math.cos((j * Math.PI * 2) / e) * Math.cos(m)
                    )
                  ),
                  this.uvs.push([j / e, q]);
            }
          ...
          (d.prototype.cylinder = function (a, b, c, f) {
            ...
            if (!this._renderer.geometryInHash(g)) {
              ...
              e.call(h, 1, 1, 1, c, f, !0, !0),
                h.computeNormals(),
                c <= 24 && f <= 16
                  ? (h._makeTriangleEdges(), this._renderer._edgesToVertices(h))
                  : console.log(
                      "Cannot draw stroke on cylinder objects with more than 24 detailX or 16 detailY"
                    ),
                this._renderer.createBuffers(g, h);
            }
            ...
            (d.RendererGL.prototype.triangle = function (a) {
              ...
              if (!this.geometryInHash(i)) {
                ...
                k._makeTriangleEdges(),
                  this._edgesToVertices(k),
                  k.computeNormals(),
            ...
            (d.RendererGL.prototype.ellipse = function (a) {
              ...
              if (!this.geometryInHash(h)) {
                ...
                j.computeNormals(),
                  g <= 50
                    ? (j._makeTriangleEdges(), this._edgesToVertices(j))
                    : console.log(
            ...
            (d.RendererGL.prototype.rect = function (a) {
              ...
              if (!this.geometryInHash(i)) {
                ...
                k.computeFaces().computeNormals()._makeTriangleEdges(),
                  this._edgesToVertices(k),
                  this.createBuffers(i, k);
              }
              var l = this.uMVMatrix.copy();
            ...
            (d.RendererGL.prototype.quad = function (a, b, c, e, f, g, h, i) {
              ...
              if (!this.geometryInHash(j)) {
                ...
                l.computeNormals()._makeTriangleEdges(),
                  this._edgesToVertices(l),
                  (l.faces = [
                    [0, 1, 2],
                    [2, 3, 0]
                  ]),
